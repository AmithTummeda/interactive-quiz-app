const questions = [
...

  {
    ...
    questions: [
      {
        question: "Which sport is considered the most popular in the world?",
        options: ["Basketball", "Cricket", "Football (Soccer)", "Tennis"],
        correctAnswer: 2,
      },
      {
        question: "What is the name of the large multi-sport event held every four years?",
        options: ["Olympics", "Commonwealth Games", "World Series", "Super Bowl"],
        correctAnswer: 0,
      },
      {
        question: "Which of these is NOT one of the five Olympic ring colors?",
        options: ["Blue", "Green", "Red", "Purple"],
        correctAnswer: 3,
      },
      {
        question: "What material is often used for weights in bicycle races?",
        options: ["Aluminum", "Glass", "Lead", "Silver"],
        correctAnswer: 2,
      },
      {
        question: "What equipment is used to hit a ball in table tennis?",
        options: ["Bat", "Racket", "Paddle", "Club"],
        correctAnswer: 2,
      },
      {
        question: "In which sport would you hear the terms 'love' and 'deuce'?",
        options: ["Basketball", "Cricket", "Tennis", "Golf"],
        correctAnswer: 2,
      },
      {
      ...
      {
        question: "What is the name for the flat rubber disc used in ice hockey?",
        options: ["Ball", "Disc", "Cone", "Puck"],
        correctAnswer: 3,
      },
      {
        question: "Who is known as the 'God of Cricket' in India?",
        options: ["Sachin Tendulkar", "Kapil Dev", "Sunil Gavaskar", "Anil Kumble"],
        correctAnswer: 0,
      },
      {
        question: "Which athlete holds the record for the most Olympic gold medals?",
        options: ["Maria Sharapova", "Michael Jordan", "Micahel Phelps", "Usain Bolt"],
        correctAnswer: 2,
      },
      {
        question: "Who was the captain of the Indian cricket team when they won the 1983 Cricket World Cup?",
        options: ["Kapil Dev", "Sourav Ganguly", "Mahendra Singh Dhoni", "Virat Kohli"],
        correctAnswer: 0,
      },
      {
        question: "In which Summer Olympics, 'Field Hockey' was introduced for the first time?",
        options: ["1920", "1916", "1912", "1908"],
        correctAnswer: 3,
      },
      {
        question: "Who is the first Indian badminton woman player to earn an Olympic silver medal?",
        options: ["Saina Nehwal", "P. V. Sindhu", "Jwala Gutta", "Ashwini Ponnappa"],
        correctAnswer: 1,
      },
      {
        question: "Who is the first person to golf anywhere other than Earth?",
        options: ["Jack Nicklaus", "Alan Shepard", "Arnold Palmer", "Tiger Woods"],
        correctAnswer: 1,
      },
      {
        question: "Mary Kom is renowned worldwide for her role as",
        options: ["Indian Archer", "Indian Wrestler", "Indian Shooter", "Indian Boxer"],
        correctAnswer: 3,
      },
      {
        question: "Which country has won the most Olympic gold medals in field hockey?",
        options: ["India", "Australia", "Germany", "China"],
        correctAnswer: 0,
      },
      {
      ...
      {
        question: "Who was the first player to score a double century in Test cricket?",
        options: ["Don Bradman", "Sunil Gavaskar", "Brian Lara", "W. G. Grace"],
        correctAnswer: 0,
      },
      {
      ...
      {
        question: "Which club has won the most FA Cups?",
...

  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["Emma Watson", "Emma Stone", "Emma Corrin", "Emily Watson"],
        correctAnswer: 0,
      },
      {
      ...
      },
      {
        ...
        options: ["Jack Kirby", "Stan Lee", "Art Vandalay", "John Romita"],
        correctAnswer: 1,
      },
      {
      ...
      {
        question: "Which TV series features the characters of Christopher Moltisanti and Adriana?",
